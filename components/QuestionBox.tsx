...
// Chipy PŘESNĚ a v tomto pořadí dle zadání v1.1 F.1
const SUGGESTIONS = [
  "Myslí na mě můj ex?",
  "Ozve se ještě?",
  "Mám čekat?",
  ...
  return (
    <div>
      ...
      <button
        onClick={() => go(q)}
        disabled={!q.trim()}
        className="mt-5 w-full rounded-xl bg-love px-6 py-4 text-lg font-semibold text-plum-900 shadow-glow transition hover:opacity-90 disabled:opacity-60 disabled:saturate-[.35]"
      >
        Vyložit karty
      </button>
    </div>
