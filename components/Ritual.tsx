          ...
          <div className="py-4">
            {phase === "picking" && (
              <div className="mb-4 text-center">
                ...
                <p className="mt-1 text-sm text-cream-dim" aria-live="polite">
                          ...
                          {h ? (
                            ...
                            <div
                              className={`h-full w-full rounded-lg border border-dashed ${
                                isNext ? "border-gold-dim" : "border-night-line/70"
                              }`}
                            />
                          )}
                        </AnimatePresence>
      ...
      {phase === "picking" && (
        <div className="flex flex-1 flex-col justify-end">
          ...
          {!fanFull && held.length === 0 && (
            <span className="pointer-events-none absolute inset-x-0 bottom-1 z-[60] text-center text-xs text-cream-dim/80">
          ...
          <div className="mt-2 flex justify-center">
            <button
              ...
              className="text-[13px] text-cream-dim underline decoration-night-line underline-offset-4 hover:text-cream disabled:no-underline disabled:opacity-35"
            >
              Zamíchat znovu
            </button>
          </div>
            ...
            <AnimatePresence>
              {flipped && (
                <motion.span
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="min-h-8 text-center text-xs leading-tight text-gold-soft"
                >
                  {positions[i]}
