...
export default function ThreePaths({
  ...
  return (
    <section className="mt-12 space-y-5">
      ...
      {/* Cesta 1 (F.7: primární gradient CTA, cena drobně pod) */}
      <div className="rounded-2xl border border-surface bg-surface p-5">
        <a
          href="/vyklad/novy"
          className="inline-block rounded-xl bg-love px-6 py-3.5 font-semibold text-plum-900 transition hover:opacity-90"
        >
