...
function CardBackSvg({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <rect x="5" y="5" width="110" height="190" rx="7" fill="none" stroke={palette.gold.DEFAULT} strokeWidth="1.4" />
      <rect x="10" y="10" width="100" height="180" rx="5" fill="none" stroke={palette.gold.dim} strokeWidth="0.7" />
      {/* Centrální osmicípá hvězda */}
      <g stroke={palette.gold.DEFAULT} strokeWidth="1.2" fill="none">
      ...
      {/* Rohové hvězdičky */}
      <g fill={palette.gold.soft} opacity="0.85">
        {[
          [22, 28],
          [98, 28],
          [22, 172],
      ...
      <g fill={palette.gold.dim} opacity="0.5">
...
function CardFaceSvg({
  ...
  return (
    ...
    >
      ...
      <rect x="11" y="11" width="98" height="178" rx="4" fill="none" stroke={palette.gold.DEFAULT} strokeWidth="1" />
      <g transform={reversed ? "rotate(180 60 100)" : undefined}>
        ...
        <line x1="28" y1="160" x2="92" y2="160" stroke={palette.gold.DEFAULT} strokeWidth="0.8" />
      </g>
    </svg>
  );
}
