    ...
    return (
      <div className="py-12">
        ...
        <button
          ...
          className="mt-8 w-full rounded-xl bg-rose-500 px-6 py-4 text-lg font-medium text-plum-900 hover:opacity-90 disabled:opacity-40 sm:w-auto"
        >
          ...
          <>
            ...
            <div className="mt-8 rounded-2xl border border-accent-dim/40 bg-surface p-6">
              ...
              <div className="mt-6 grid gap-3">
                {creditsEnabled && credits > 0 ? (
                  <button
                    ...
                    className="rounded-xl bg-rose-500 px-6 py-3.5 font-medium text-plum-900 hover:opacity-90 disabled:opacity-40"
                  >
                  ...
                  <>
                    ...
                    <button
                      onClick={pay}
                      disabled={payDisabled}
                      className="rounded-xl bg-love px-6 py-3.5 font-semibold text-plum-900 hover:opacity-90 disabled:opacity-60 disabled:saturate-[.35]"
                    >
              ...
              <p className="mt-5 text-xs text-body-dim">
                {creditsEnabled && credits > 0
                  ? `Výklady generuje ${PERSONA_FULL}. Po vydání výkladu ti ${vykladu(credits - 1)}.`
                  : `Výklady generuje ${PERSONA_FULL}. Pokud ti první výklad nic nedá, napiš nám a ${PRICES.first} Kč ti vrátíme.`}
              </p>
            </div>
          </>
        )}
