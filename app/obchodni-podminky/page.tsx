...
export default function Page() {
  return (
    <article className="prose-tarot py-10 leading-relaxed text-cream-dim">
      ...
      <h2 className="mt-8 font-display text-2xl text-cream">1. Provozovatel</h2>
      <p>TODO: identifikace provozovatele, IČO, sídlo, kontakt.</p>
      <h2 className="mt-6 font-display text-2xl text-cream">2. Služba</h2>
      <p>
      ...
      <h2 className="mt-6 font-display text-2xl text-cream">3. Ceny a platby</h2>
      <p>
      ...
      <h2 className="mt-6 font-display text-2xl text-cream">4. Dodání a odstoupení</h2>
      <p>
      ...
      <h2 className="mt-6 font-display text-2xl text-cream">5. Garance spokojenosti</h2>
      <p>
