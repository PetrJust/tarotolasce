...
export default function Page() {
  return (
    <article className="prose-tarot py-10 leading-relaxed text-body-dim">
      ...
      <h2 className="mt-8 font-display text-2xl text-body">Garance prvního výkladu</h2>
      <p>
      ...
      <h2 className="mt-6 font-display text-2xl text-body">Technické problémy</h2>
      <p>
      ...
      <h2 className="mt-6 font-display text-2xl text-body">Postup reklamace</h2>
