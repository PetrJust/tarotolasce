  ...
  async function verifyOptin(code: string) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setOptinCode("");
        setOptinError("Kód nesedí, nebo už vypršel. Zkus to znovu, nebo si nech poslat nový.");
      }
    } finally {
      setOptinBusy(false);
    }
    ...
    <div className="py-10">
      ...
      {phase === "intro" && (
        <div className="mt-6">
          ...
          <button
            onClick={start}
            className="mt-8 rounded-xl bg-rose-500 px-8 py-4 text-lg font-medium text-plum-900 shadow-glow hover:opacity-90"
          >
        ...
        <div className="mt-6">
          ...
          <section className="mx-auto mt-14 max-w-xl space-y-4 text-left text-sm leading-relaxed text-body-dim">
            ...
            <p>
              ...
              otočíš ráno nebo kdykoli během dne, a krátký vzkaz od {PERSONA_NAME}, naší
            ...
            <p>
              ...
              tah ze všech 78 karet tarotu, včetně obrácených pozic, a {PERSONA_NAME} k
