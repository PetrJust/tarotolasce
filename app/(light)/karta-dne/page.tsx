...
export default function KartaDnePage() {
  ...
  return (
    <div className="py-10">
      ...
      {phase === "already" && (
        <div className="mt-6 rounded-2xl border border-night-line bg-night-soft/60 p-6">
          <p className="text-cream">Dnešní kartu už sis vytáhla.</p>
          ...
          <Link
            href="/vyklad/novy"
            className="mt-5 inline-block rounded-xl border border-gold-dim px-6 py-3 text-gold-soft hover:border-gold"
          >
      ...
      {(phase === "reading" || phase === "done") && card && (
        <div className="mt-6">
          <div className="mx-auto max-w-40 text-center">
            <span className="text-xs text-gold-soft">Dnešní karta</span>
            <div className="mt-1 rounded-xl border border-night-line bg-cream/95 p-4 text-night">
          ...
          {phase === "done" && (
            <div className="mt-8 space-y-4 text-center">
              ...
              <div className="mx-auto mt-6 max-w-md rounded-2xl border border-night-line bg-night-soft/50 p-5 text-left">
                {optinSent ? (
                  ...
                  <>
                    ...
                    <div className="mt-3 flex gap-2">
                      <input
                        ...
                        className="w-full rounded-xl border border-night-line bg-night-deep/60 p-2.5 text-sm text-cream"
                      />
                      <button
                        onClick={submitOptin}
          ...
          <section className="mx-auto mt-14 max-w-xl space-y-4 text-left text-sm leading-relaxed text-cream-dim">
