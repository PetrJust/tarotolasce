  ...
  return (
    <div className="py-10">
      ...
      <div className="mt-10 space-y-10">
        {EMAILS.map((e) => (
          <section key={e.id}>
            <h2 className="text-xs uppercase tracking-wider text-gold-soft">
              {e.group}
            </h2>
            <div className="mt-2 overflow-hidden rounded-2xl border border-night-line">
              <div className="border-b border-night-line bg-night-soft/70 px-5 py-3 text-sm">
                <p className="text-cream">
                  <span className="text-cream-dim">Předmět:</span> {e.subject}
                </p>
              ...
              <div className="bg-cream px-6 py-6 text-night">
                <p className="font-display text-lg font-semibold">
                  Tarot <span className="text-gold-dim">o Lásce</span>
                </p>
                ...
                {e.cta && (
                  <div className="mt-5">
                    <span className="inline-block rounded-xl bg-night px-5 py-3 text-sm font-medium text-cream">
                      {e.cta.label}
                    </span>
