...
export default function CardPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <article className="py-10">
      ...
      />
      <nav className="text-sm text-cream-dim">
        <Link href="/vyznam-karet" className="hover:text-cream">
          Významy karet
        </Link>{" "}
        / <span className="text-cream">{card.name}</span>
      </nav>
      ...
      {content.isPlaceholder && (
        <p className="mt-4 rounded-xl border border-gold-dim/40 bg-night-soft/60 p-3 text-xs text-gold-soft">
      ...
      <section className="mt-8">
        ...
        <p className="mt-3 leading-relaxed text-cream-dim">{content.upright}</p>
      </section>
      ...
      <section className="mt-8">
        ...
        <p className="mt-3 leading-relaxed text-cream-dim">{content.reversed}</p>
      </section>
      ...
      <section className="mt-12 rounded-2xl border border-gold-dim/40 bg-night-soft/60 p-6 text-center">
