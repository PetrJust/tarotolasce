...
export default function Page() {
  return (
    <article className="prose-tarot py-10 leading-relaxed text-body-dim">
      ...
      <h2 className="mt-8 font-display text-2xl text-body">1. Správce údajů</h2>
      <p>TODO: identifikace správce a kontakt na pověřence, pokud je ustanoven.</p>
      <h2 className="mt-6 font-display text-2xl text-body">2. Jaké údaje zpracováváme</h2>
      <p>
      ...
      <h2 className="mt-6 font-display text-2xl text-body">3. Účel a právní základ</h2>
      <p>TODO: plnění smlouvy, oprávněný zájem, souhlas u marketingu.</p>
      <h2 className="mt-6 font-display text-2xl text-body">4. Doba uchování a práva</h2>
      <p>
        TODO: doba uchování, právo na výmaz, přístup, přenositelnost a podání
        stížnosti u ÚOOÚ.
      </p>
      <h2 className="mt-6 font-display text-2xl text-body">5. Cookies</h2>
      <p>
